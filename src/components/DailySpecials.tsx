    ...
    <section id="tagesangebot" className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Reveal delay={0} className="bg-white p-8 speed-cut border-t-4 border-t-amber-500 border border-gray-100 shadow-md group hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
          ...
          <Reveal delay={120} className="bg-white p-8 speed-cut border-t-4 border-t-race border border-gray-100 shadow-md group hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
          ...
          <Reveal delay={240} className="bg-white p-8 speed-cut border-t-4 border-t-green-500 border border-gray-100 shadow-md group hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
