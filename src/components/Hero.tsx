...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 overflow-hidden bg-lotteria-red">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 w-full flex flex-col items-center text-center">
        <Reveal className="w-full space-y-4 sm:space-y-6 mb-10">
      ...
      <Reveal delay={250} className="absolute -bottom-12 -left-12 w-56 h-56 sm:-bottom-16 sm:-left-16 sm:w-72 sm:h-72 md:-bottom-20 md:-left-20 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-8 border-white rotate-[-10deg]">
        <img src="images/schnitzel.png" alt="Knuspriges Schnitzel mit Pommes" className="w-full h-full object-cover" />
      </Reveal>
      <Reveal delay={350} className="absolute top-20 -right-8 w-40 h-40 sm:top-28 sm:-right-10 sm:w-56 sm:h-56 md:top-32 md:w-72 md:h-72 rounded-full overflow-hidden shadow-2xl border-8 border-white rotate-[15deg]">
