      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <a href="https://www.google.com/maps/search/?api=1&query=Handelszentrum+Bergheim+Salzburg" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-race text-white hover:bg-race-700 px-8 py-4 font-display font-bold text-sm uppercase tracking-wide transition-all speed-cut shadow-md shadow-race/20"><Navigation size={18} /> In Maps öffnen</a>
          </div>
          <div id="zeiten" className="lg:pl-12 lg:border-l border-gray-200">
