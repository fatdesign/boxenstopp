  ...
  return (
    <section ref={containerRef} className="relative bg-lotteria-red h-[200vh] w-full">
      <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden">
        ...
        <div className="px-4 sm:px-8 md:px-16 mb-8 sm:mb-12 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
          <div>
            <h2 className="font-display font-black text-5xl sm:text-6xl md:text-8xl text-lotteria-yellow uppercase tracking-tighter leading-[0.9]">
              ES KANN<br />NUR<br />SCHMECKN
            </h2>
          </div>
          <div className="text-white max-w-lg space-y-4 sm:space-y-6">
            ...
            <a href="#menu" onClick={(e) => { e.preventDefault(); scrollToId('menu'); }} className="inline-block bg-white text-lotteria-red px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-transform shadow-lg">
              Unsere Speisen
            </a>
          </div>
        </div>
